						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<div class="box-body pad table-responsive">
									<p>
										Various types of buttons. Using the base class <code>
											.btn</code>
									</p>
					...
					<div class="row">
							...
							<div class="box">
								...
								<div class="box-body">
									<p>
										...
										We are using <code>
											.btn.btn-social</code>
										and to add the colors to the buttons we use the <code>
											.bg-*</code>
										classes.
									</p>
									<button class="btn bg-blue btn-social">
										<i class="fa fa-facebook"></i><span>Like us on Facebook</span>
									</button>
									<br />
									<br />
									<button class="btn bg-red btn-social">
										<i class="fa fa-google-plus"></i><span>Share with your circles</span>
									</button>
									<br />
									<br />
									<button class="btn bg-aqua btn-social">
										<i class="fa fa-twitter"></i><span>Tweet to the globe</span>
									</button>
									<br />
									<br />
									<button class="btn bg-navy btn-social">
										<i class="fa fa-github-alt"></i><span>Fork me on Github</span>
									</button>
									<br/>
									<br/>
									<!-- circled -->
									<button class="btn bg-blue btn-circle">
									...
									<button class="btn bg-navy btn-circle">
						...
						<div class="col-md-6">
							...
							<div class="box">
								...
								<div class="box-body">
									<p>
										Mix and match with various background colors. Use base class <code>
											.btn</code>
										and add any available <code>
											.bg-*</code>
										class
									</p>
									...
									<p>
										...
										<button class="btn bg-purple btn-flat margin">
											.btn.bg-purple.btn-flat
										</button>
										<button class="btn bg-navy btn-flat margin">
