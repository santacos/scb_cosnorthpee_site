						...
						<section class="col-lg-6 connectedSortable">
							...
							<div class="box box-success">
								...
								<div class="box-body chat" id="chat-box">
									<!-- chat item -->
									<div class="item">
										<img src="{{asset('assets/img/avatar.png')}}" class="online" alt="User Image" />
										<p class="message">
									...
									<!-- chat item -->
									<div class="item">
										<img src="{{asset('assets/img/avatar2.png')}}" class="offline" alt="User Image" />
										<p class="message">
									...
									<!-- chat item -->
									<div class="item">
										<img src="{{asset('assets/img/avatar3.png')}}" class="offline" alt="User Image" />
										<p class="message">
