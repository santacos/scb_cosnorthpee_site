...
<html>
	...
	<body class="skin-black">
		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="right-side">
				...
				<section class="content-header">
					<h1> Advanced Elements page <small>Control panel</small></h1>
					<ol class="breadcrumb">
						<li>
							<a href="#"><i class="fa fa-dashboard"></i> Home</a>
						</li>
						<li class="active">
							Advanced Elements page
						</li>
					</ol>
				</section>
								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<label>
											...
											Minimal red skin checkbox </label>
									</div>
        ...
        {{ HTML::script('assets/js/plugins/colorpicker/bootstrap-colorpicker.min.js') }}
